	...
	<xsl:template match="/">
		...
		<form name="search_form" target="_self" method="post" action="{$baseActionURL}">
        	...
        	<div class="content">
               ...
               <xsl:call-template name="store_add" />
        	</div>
		</form>
	</xsl:template>
	
	<xsl:template name="store-add" >
		<h2>Add Store</h2>
            	
               <p class="content-label">Campus</p>
               <p class="content-option">
               		<xsl:value-of select="/data/campus/name" />
               </p>
            
               <p class="content-label">Store Name</p>
               <p class="content-option">
               		<input type="text" size="30" value="{/data/store/name}"/>
               </p>
           
               <p class="content-label">Address</p>
               <p class="content-option">
               		<input type="text" size="45" value="{/data/store/address}"/>
               </p>
            
               <p class="content-label">City</p>
               <p class="content-option">
               		<input type="text" size="30" value="{/data/store/city}"/>
               </p>
            
               <p class="content-label">Phone</p>
               <p class="content-option">
               		<input type="text" size="20" value="{/data/store/phone}"/>
               </p>
            
               <p class="content-label">Zip</p>
               <p class="content-option">
               		<input type="text" size="6" value="{/data/campus/zip}"/>
               </p>
